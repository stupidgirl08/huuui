#You can just fill it here after forking by removing the things after '=' and renaming it to config.py
...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/Kazama009/Retrogini-Userbot.git"
    )
