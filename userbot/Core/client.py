...
class ZealousClient(TelegramClient):
    def cmd(
        self: TelegramClient,
        ...
        **kwargs,
        ...
        if globals("blacklist_chats") is not None:
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**Zealous Error report**\n\n"
                        link = "[here](https://t.me/zealous_support)"
            ...
            if pattern is not None:
                ...
                if allow_sudo and globals("sudoenable") is not None:
                ...
                if edited:
                    client.add_event_handler(func, events.MessageEdited(**kwargs))
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                client.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                client.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
